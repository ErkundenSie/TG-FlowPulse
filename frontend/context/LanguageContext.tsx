...
const translations: Translations = {
    zh: {
        ...
        "save": "保存",
        "cancel": "取消",
        "settings_desc": "Telegram 多账号自动化任务编排、消息监听、通知转发与签到管理面板",
        "settings_title": "系统设置",
        "logout": "退出登录",
        "connected": "已连接",
        ...
        "telegram_bot_notify_desc": "任务执行失败后/关键词命中后通过 Bot API 发送通知",
    ...
    en: {
        ...
        "save": "Save",
        "cancel": "Cancel",
        "settings_desc": "A Telegram multi-account automation panel for task workflows, message monitoring, notification forwarding, and check-in management",
        ...
        "cron_example": "Format: minute hour day month weekday; example: 0 6 * * * (daily 06:00)",
        ...
        "timezone_desc": "Used for sign-in scheduling and random time ranges; saving immediately reschedules jobs",
        ...
        "telegram_bot_notify_desc": "Send a Bot API message when a task fails or a keyword matches",
