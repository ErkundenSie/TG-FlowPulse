...
const translations: Translations = {
  zh: {
    ...
    chat_migration_json_placeholder: "粘贴从其他账号导出的 tg_chats_*.json 内容",
  ...
  en: {
    ...
    chat_migration_json_placeholder: "Paste tg_chats_*.json exported from another account",
    ...
    chat_migration_load_list_hint: "Load the list first, then select groups or channels to export.",
