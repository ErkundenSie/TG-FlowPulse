            ...
            <div className="space-y-4">
                <div className="settings-toggle-row">
                    <div>
                        ...
                        <p className="settings-hint !mt-0">{t("telegram_bot_notify_desc")}</p>
                    </div>
                    <Toggle
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="settings-toggle-row">
                        <div>
                            ...
                            <p className="settings-hint !mt-0">{t("telegram_login_notify_desc")}</p>
                        </div>
                        <Toggle
                    ...
                    <div className="settings-toggle-row">
                        <div>
                            ...
                            <p className="settings-hint !mt-0">{t("telegram_task_failure_notify_desc")}</p>
                        </div>
                        <Toggle
