...
function Toggle({
  ...
  return (
    ...
    >
      <span
        className={`absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all shadow-md ${checked ? "left-6" : "left-0.5"}`}
      />
    </button>
  );
}
    ...
    <div className="settings-panel">
      <div className="settings-panel-header">
        <div className="settings-panel-title">
          <div className="settings-panel-icon bg-cyan-500/10 text-cyan-400">
      ...
      <div className="space-y-4">
        <div className="settings-toggle-row">
          <div>
            <label className="text-[11px] mb-1">
              {t("telegram_bot_master_switch")}
            </label>
            <p className="settings-hint !mt-0">
              {t("telegram_bot_notify_desc")}
            </p>
          </div>
          <Toggle
            ...
            onChange={() =>
              setSettings({
                ...
                telegram_bot_notify_enabled:
                  !settings.telegram_bot_notify_enabled,
              })
            }
          />
        </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  telegram_bot_chat_id: e.target.value || null,
                })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({
                  ...settings,
                  telegram_bot_message_thread_id: e.target.value
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="settings-toggle-row">
            <div>
              <label className="text-[11px] mb-1">
                {t("telegram_login_notify")}
              </label>
              <p className="settings-hint !mt-0">
                {t("telegram_login_notify_desc")}
              </p>
            </div>
            <Toggle
              ...
              onChange={() =>
                setSettings({
                  ...
                  telegram_bot_login_notify_enabled:
                    !settings.telegram_bot_login_notify_enabled,
                })
              }
            />
          </div>
          ...
          <div className="settings-toggle-row">
            <div>
              <label className="text-[11px] mb-1">
                {t("telegram_task_failure_notify")}
              </label>
              <p className="settings-hint !mt-0">
                {t("telegram_task_failure_notify_desc")}
              </p>
            </div>
            <Toggle
              ...
              onChange={() =>
                setSettings({
                  ...
                  telegram_bot_task_failure_enabled: !(
                    settings.telegram_bot_task_failure_enabled !== false
                  ),
                })
              }
            />
        ...
        <div className="settings-actions">
          <button className="btn-gradient" onClick={onSave} disabled={loading}>
